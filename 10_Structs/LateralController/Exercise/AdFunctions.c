...
void init_vehicles(NeighborVehiclesType *vehicles)
{
    ...
    init_vehicle(&vehicles->vehicles_center_lane[0],2,40.0f,50.0f,LANE_ASSOCIATION_TYPE_CENTER);
    init_vehicle(&vehicles->vehicles_center_lane[1],3,-60.0f,30.0f,LANE_ASSOCIATION_TYPE_CENTER);

    init_vehicle(&vehicles->vehicles_right_lane[0],4,80.0f,60.0f,LANE_ASSOCIATION_TYPE_RIGHT);
